...
export default function Reports() {
  ...
  return (
    <div>
      <PageHeader eyebrow="Analytics" title="Global Project Library activity"
                   description="Operational reporting for the Project Library — production applications, partner project submissions and library composition. Customer commercials remain confidential to country partners." />
      <div className="px-10 py-10 space-y-6">
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
          <Metric label="Applications · Pending" value={apps.submitted ?? "—"} tone="warning" />
          <Metric label="Applications · Approved" value={apps.approved ?? "—"} tone="positive" />
          <Metric label="Partner ideas · In review" value={partners.in_review ?? "—"} tone="warning" />
          <Metric label="Partner ideas · Approved" value={partners.approved ?? "—"} tone="positive" />
          <Metric label="Projects · Active" value={lib.active ?? "—"} tone="positive" />
        ...
        <div className="imh-card">
          <div className="px-6 py-4 border-b border-[#E4E4E1]">
            ...
            <h3 className="font-editorial text-xl mt-1">Approved productions per project</h3>
          </div>
